...
public class HotFix {
    ...
    public static void installPatch(Application application, File patch) {
        ...
        try {
            Field pathListField = com.medisana.hotfix.ReflectUtils.findField(classLoader, "pathList");
            ...
            //修改dexElements
            Method method = com.medisana.hotfix.ReflectUtils.findMethod(pathList, "makePathElements", List.class, File.class, List.class);
            //静态方法
            Object[] patchElements = (Object[]) method.invoke(null, patchs, file, exceptions);

            //3.2
            Field dexElementsField = com.medisana.hotfix.ReflectUtils.findField(pathList, "dexElements");
